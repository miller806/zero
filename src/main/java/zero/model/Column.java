...
import zero.util.DatabaseDataTypesUtils;
import zero.util.StringHelper;
...
//		}
	...
	public boolean isLongClass() {
		return getJavaType().isPrimitive() || getJavaType().getName().startsWith("java.lang");
	}

	public boolean isStr() {
		return getJavaType().equals(String.class);
	}
