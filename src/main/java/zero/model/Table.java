...
public class Table {
    ...
    public String getClassName() {
        return (className == null ? StringHelper.makeAllWordFirstLetterUpperCase(getSqlName().replace(PropertiesProvider.getProperty("prefix"), "")) : className);
    }
